...
import { BcsType, EnumOutputShapeWithKeys } from "@mysten/bcs";

//todo: @alexanderludwig or @fl0ydj fix the types here
...
export interface DataWithTypes {
  /* eslint-disable @typescript-eslint/no-explicit-any */
  data: EnumOutputShapeWithKeys<any, string>;
  type: string;
}

export type ObjectId = string;

export type ObjectCallArg = { Object: bcs.ObjectArg };
